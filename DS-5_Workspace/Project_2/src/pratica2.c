...
int main()
{
	...
	long int res;
	res = Maxdword(v, n);
	printf("O valor m�nimo do vetor � = %ld\n", res);
	return 0;
}
...
int main()
{
	char v[] = "Amanh� s�o cinco   palavras eheh";
	int res;
	res = npalavras(v);
...
int main()
{
	...
	int res1;
	res1 = POS1msb(x);
	printf("O primeiro 1 encontra-se na posi��o %ld.\n", res);
	printf("O primeiro 1 encontra-se na posi��o %ld.\n", res1);
	return 0;
}
...
int main()
{
	...
	res = NCAP(n);
	if(res == 1)
		printf("O n�mero � uma capicua.\n");
	else if(res == 0)
		printf("O n�mero  nao � uma capicua.\n");
		return 0;
}
...
int main()
{
	...
	int res;
	res = countbit(n);
	printf("Sao necessarios %d bits para escrever o n�mero %d.\n", res, n);
	return 0;
}
...
// no final da execu�ao a sequencia ve[] = {7, -8, -20, 20, 20, -10, 0, 20} (podem verificar
...
int main(void)
{
	...
	printf("N�mero de elementos de vectA[] em vectB[]: %u\n", res);
